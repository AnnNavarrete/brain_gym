...
var generateStartup = function() {
  var startUp = thisArray[Math.floor(Math.random() * thisArray.length)];
  var idea = thatArray[Math.floor(Math.random() * thatArray.length)];
  var randomThis = thisArray[startUp];
  var randomThat = thatArray[idea];

  console.log(randomThis + " for " + randomThat);
};
